                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_1_1">
                                                <div class="scroller" style="height: 422px;" data-always-visible="1" data-rail-visible="0">
                                                    <ul class="feeds">
                                                        <li>
                                                            <div class="col1">
                                                                <div class="cont">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-red bold uppercase">Statistik Penjualan</span>
                                        </div>
                                        <ul class="nav nav-tabs">
                                            <li class="active">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Data Order</span>
                                            <span class="caption-helper">Order overview...</span>
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">
